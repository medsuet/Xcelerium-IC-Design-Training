/*
    Name: SequentialSignedMultiplier.cpp
...
#include "VSequentialSignedMultiplier.h"
#include "VSequentialSignedMultiplier___024root.h"
...
// Function prototypes
void driver(VSequentialSignedMultiplier *dut);
void monitor(VSequentialSignedMultiplier *dut);
...
int main(int argc, char** argv, char** env) {
    ...
    // Connect to dut
    VSequentialSignedMultiplier *dut = new VSequentialSignedMultiplier;
