...
# Calculate no. of cycles in a given time period
proc calc_cycles {frequency time_period} {
    return [expr {$frequency * $time_period}]
}
set cap_pf 10.0
set voltage 1.2
...
# calling calc_cycles function
set no_of_cycles [calc_cycles $clock_freq_mhz $clock_period_ns]
puts "The No. of Cycles in a Time Period is: $no_of_cycles cycles"