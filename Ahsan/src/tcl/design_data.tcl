...
dict set module_sizes Cache 2500
dict set module_sizes Logic_Unit 750

# Procedure to find modules larger than a given size
proc find_large_modules {size_threshold} {
    global module_sizes
    set large_modules ""
    dict for {module size} $module_sizes {
...
# Experiment with the procedure
set size_threshold 1000
set large_modules [find_large_modules $size_threshold]
puts "\nModules larger than $size_threshold gates:"
