...
# Add more modules
lappend modules "Adder" "Subtractor"
puts "\nAfter adding Adder and Subtractor:"
puts $modules
...
dict set module_sizes Adder 800
dict set module_sizes Subtractor 900
...
proc find_large_modules {dict_name size_threshold} {
    set large_modules {}
    dict for {module size} $dict_name {
...
set size_threshold 1000
set large_modules [find_large_modules $module_sizes $size_threshold]
puts "\nModules larger than $size_threshold gates: $large_modules"
