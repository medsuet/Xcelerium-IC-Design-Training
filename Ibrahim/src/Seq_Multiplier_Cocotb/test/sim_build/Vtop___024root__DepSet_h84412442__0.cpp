...
void Vtop___024root___eval_triggers__act(Vtop___024root* vlSelf) {
    ...
    auto &vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.__VactTriggered.set(0U, (((IData)(vlSelfRef.tb_seq_multiplier__DOT__clk) 
                                        & (~ (IData)(vlSelfRef.__Vtrigprevexpr___TOP__tb_seq_multiplier__DOT__clk__0))) 
                                       | ((~ (IData)(vlSelfRef.tb_seq_multiplier__DOT__rst)) 
                                          & (IData)(vlSelfRef.__Vtrigprevexpr___TOP__tb_seq_multiplier__DOT__rst__0))));
