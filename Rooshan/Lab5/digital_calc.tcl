...
set given_time_period 6

set num_clock_cycles [expr {$max_freq_mhz * 1000000 * $given_time_period }]
puts "Number of clock cycles in a given time period = $num_clock_cycles "